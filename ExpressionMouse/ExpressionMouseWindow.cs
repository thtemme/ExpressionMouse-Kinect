...
namespace ExpressionMouse
{
    public partial class ExpressionMouse : Form
    {
        ...
        private bool DragnDropActive = false;
        ...
        private void HandleScrolling(float browRaiserValue, float browLowererValue)
        {
        ...
        private void WriteDataToMembers(ColorImageFrame colorImageFrame, DepthImageFrame depthImageFrame, SkeletonFrame skeletonFrame)
        {
        ...
        private void HandlePossibleImageFormatChanges(ColorImageFrame colorImageFrame, DepthImageFrame depthImageFrame)
        {
        ...
        /// <summary>
        /// Handle mouse click actions according to eye state
        /// </summary>
        /// <returns></returns>
        private bool HandleMouseClickActions()
        {
        ...
        private void FaceMouseConfig_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
                //Do nothing if parameters couldn't be serialized (e.g. due to no File write permission).
            }            
        }
